            ...
            <div class='max-w-[480px]'>
                ...
                <div>
                    <form method="POST" action="/auth/local/register">
                        ...
                        <div class="mb-6">
                            <button type="submit" class="w-full bg-laravel text-white bg-black rounded py-2 px-4 duration-150 hover:scale-105">
                                Sign In
                            </button>
                        </div>
                    </form>
                ...
                <div class='mt-6'>
                    <p>
                        ...
                        <a href="/login" class="text-laravel text-cyan-700">Login</a>
                    </p>
                </div>
            </div>
        </div>
